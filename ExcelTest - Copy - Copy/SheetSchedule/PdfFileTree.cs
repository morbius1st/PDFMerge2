...
using static ExcelTest.SheetSchedule.TreeItemType;
...
namespace ExcelTest.SheetSchedule
{
	...
	public class PfTreeLeaf : ITreeItem
	{
		...
		public PfTreeLeaf(FilePath<FileNameSimple> filePath, string bookmark, int pageCount, bool keepBookmarks)
		{
			ItemType = TI_LEAF;
			FilePath = filePath;
			PageCount = pageCount;
		...
		public FilePath<FileNameSimple> FilePath { get; }
